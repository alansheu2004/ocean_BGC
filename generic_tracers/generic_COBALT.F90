...
!
    ...
    ! get pointers for zooplankton vertical swimming
    ...
    call g_tracer_get_pointer(tracer_list,'nvmmdz','vmove',zoo(4)%p_vmove)
    call g_tracer_get_pointer(tracer_list,'nvmlgz','vmove',zoo(5)%p_vmove)
